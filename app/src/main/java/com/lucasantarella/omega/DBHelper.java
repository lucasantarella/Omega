...
public class DBHelper extends SQLiteOpenHelper{
	...
	public static final String COLUMN_TITLE_CONDENSED = "_titlecondensed";
	...
	private static final String CREATE_DB_SQL = "create table " + TABLE_FEED + " (" + COLUMN_ID + " integer primary key autoincrement, " + COLUMN_TITLE + " text not null, " + COLUMN_TITLE_CONDENSED + " text not null, "+ COLUMN_AUTHOR + " text not null, " + COLUMN_PUBDATE + " text not null, " + COLUMN_DESCRIPTION + " text not null, " + COLUMN_CONTENT + " text not null, " + COLUMN_GUID + " text not null);";
